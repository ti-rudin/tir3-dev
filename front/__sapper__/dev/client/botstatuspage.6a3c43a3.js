import { S as SvelteComponentDev, i as init, s as safe_not_equal, d as dispatch_dev, w as onMount, v as validate_slots, ai as slide, e as element, z as space, c as claim_element, b as children, f as detach_dev, C as claim_space, h as attr_dev, a6 as toggle_class, j as add_location, l as insert_dev, m as append_dev, a9 as add_render_callback, aa as create_bidirectional_transition, af as binding_callbacks, ag as bind, B as Button, p as validate_store, q as stateStore, r as component_subscribe, N as set_store_value, g as globals, x as text, A as create_component, y as claim_text, D as claim_component, k as set_style, E as mount_component, G as set_data_dev, H as transition_in, I as transition_out, J as destroy_component, ah as add_flush_callback, K as group_outros, L as check_outros, u as authStore$1, P as SignInButton, R as query_selector_all, n as noop } from './client.43ed9f7c.js';
import { T as TextField, S as Switch } from './TextField.b055b2c9.js';
...
// (332:2) {#if botstatus.currentfloor !== 0}
function create_if_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(label, file$1, 335, 10, 8977);
			add_location(strong, file$1, 336, 10, 9007);
			add_location(nobr, file$1, 334, 8, 8960);
			attr_dev(div0, "class", "leftitem svelte-1atyj0m");
			add_location(div0, file$1, 333, 6, 8929);
			...
			add_location(div1, file$1, 340, 6, 9111);
			attr_dev(div2, "class", "row svelte-1atyj0m");
			add_location(div2, file$1, 332, 4, 8905);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div2, anchor);
			append_dev(div2, div0);
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "if",
		source: "(332:2) {#if botstatus.currentfloor !== 0}",
		ctx
	});
...
// (564:2) <Button on:click={savesettings} href="/">
function create_default_slot_3(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(564:2) <Button on:click={savesettings} href=\\\"/\\\">",
		ctx
	});
...
// (567:2) <Button color="alert" on:click={panicsale}>
function create_default_slot_2(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(567:2) <Button color=\\\"alert\\\" on:click={panicsale}>",
		ctx
	});
...
// (570:2) <Button color="alert" on:click={resetsettings}>
function create_default_slot_1(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(570:2) <Button color=\\\"alert\\\" on:click={resetsettings}>",
		ctx
	});
...
// (575:2) <Button color="alert" on:click={deletebot} href="/">
function create_default_slot(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(575:2) <Button color=\\\"alert\\\" on:click={deletebot} href=\\\"/\\\">",
		ctx
	});
...
function create_fragment$1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(div0, file$1, 313, 6, 8453);
			attr_dev(div1, "class", "leftitem svelte-1atyj0m");
			add_location(div1, file$1, 312, 4, 8424);
			attr_dev(div2, "class", "row svelte-1atyj0m");
			add_location(div2, file$1, 311, 2, 8402);
			attr_dev(label0, "class", "svelte-1atyj0m");
			add_location(label0, file$1, 324, 6, 8683);
			add_location(br0, file$1, 325, 6, 8718);
			attr_dev(strong0, "class", "bg-white dark:bg-gray-900 text-black dark:text-white");
			add_location(strong0, file$1, 326, 6, 8731);
			attr_dev(div3, "class", "leftitem svelte-1atyj0m");
			add_location(div3, file$1, 323, 4, 8654);
			attr_dev(div4, "class", "row svelte-1atyj0m");
			add_location(div4, file$1, 322, 2, 8632);
			attr_dev(label1, "class", "svelte-1atyj0m");
			add_location(label1, file$1, 350, 6, 9355);
			add_location(br1, file$1, 351, 6, 9381);
			attr_dev(span0, "class", "inline-block bg-gray-200 rounded-full px-3 py-1 text-sm font-bold\n        text-gray-800");
			add_location(span0, file$1, 352, 6, 9394);
			add_location(br2, file$1, 358, 6, 9553);
			attr_dev(div5, "class", "leftitem svelte-1atyj0m");
			add_location(div5, file$1, 349, 4, 9326);
			attr_dev(label2, "class", "svelte-1atyj0m");
			add_location(label2, file$1, 362, 8, 9653);
			attr_dev(div6, "class", "rowbalanceitem svelte-1atyj0m");
			add_location(div6, file$1, 361, 6, 9616);
			attr_dev(label3, "class", "svelte-1atyj0m");
			add_location(label3, file$1, 365, 8, 9731);
			add_location(br3, file$1, 366, 8, 9760);
			attr_dev(span1, "class", "inline-block bg-gray-200 rounded-full px-3 py-1 text-sm\n          font-semibold text-gray-700");
			add_location(span1, file$1, 367, 8, 9775);
			attr_dev(div7, "class", "rowbalanceitem svelte-1atyj0m");
			add_location(div7, file$1, 364, 6, 9694);
			attr_dev(label4, "class", "svelte-1atyj0m");
			add_location(label4, file$1, 375, 8, 10008);
			add_location(br4, file$1, 376, 8, 10039);
			attr_dev(span2, "class", "inline-block bg-gray-200 rounded-full px-3 py-1 text-sm\n          font-semibold text-gray-700");
			add_location(span2, file$1, 377, 8, 10054);
			attr_dev(div8, "class", "rowbalanceitem svelte-1atyj0m");
			add_location(div8, file$1, 374, 6, 9971);
			attr_dev(div9, "class", "rightitem rowbalance svelte-1atyj0m");
			add_location(div9, file$1, 360, 4, 9575);
			attr_dev(div10, "class", "row svelte-1atyj0m");
			add_location(div10, file$1, 348, 2, 9304);
			attr_dev(label5, "class", "svelte-1atyj0m");
			add_location(label5, file$1, 389, 8, 10347);
			add_location(br5, file$1, 390, 8, 10384);
			add_location(span3, file$1, 391, 8, 10399);
			add_location(br6, file$1, 392, 8, 10432);
			add_location(span4, file$1, 393, 8, 10447);
			add_location(br7, file$1, 394, 8, 10488);
			attr_dev(div11, "class", "centereditem svelte-1atyj0m");
			add_location(div11, file$1, 388, 6, 10312);
			attr_dev(label6, "class", "svelte-1atyj0m");
			add_location(label6, file$1, 397, 8, 10549);
			add_location(br8, file$1, 398, 8, 10588);
			add_location(span5, file$1, 399, 8, 10603);
			add_location(br9, file$1, 400, 8, 10672);
			add_location(span6, file$1, 401, 8, 10687);
			add_location(br10, file$1, 402, 8, 10730);
			attr_dev(div12, "class", "centereditem svelte-1atyj0m");
			add_location(div12, file$1, 396, 6, 10514);
			attr_dev(div13, "class", "row svelte-1atyj0m");
			add_location(div13, file$1, 387, 4, 10288);
			attr_dev(div14, "class", "yelowkob svelte-1atyj0m");
			add_location(div14, file$1, 386, 2, 10261);
			attr_dev(label7, "class", "svelte-1atyj0m");
			add_location(label7, file$1, 411, 12, 10930);
			attr_dev(td0, "class", "cellleft svelte-1atyj0m");
			add_location(td0, file$1, 410, 10, 10896);
			attr_dev(td1, "class", "cellleft bordernull svelte-1atyj0m");
			add_location(td1, file$1, 413, 10, 11005);
			add_location(br11, file$1, 416, 12, 11186);
			attr_dev(td2, "rowspan", "2");
			attr_dev(td2, "class", "borderbootom borderleft svelte-1atyj0m");
			add_location(td2, file$1, 414, 10, 11074);
			attr_dev(tr0, "class", "bordernull svelte-1atyj0m");
			add_location(tr0, file$1, 409, 8, 10862);
			attr_dev(label8, "class", "svelte-1atyj0m");
			add_location(label8, file$1, 422, 12, 11384);
			attr_dev(td3, "class", "borderbootom cellleft svelte-1atyj0m");
			add_location(td3, file$1, 421, 10, 11337);
			attr_dev(td4, "class", "borderbootom cellleft svelte-1atyj0m");
			add_location(td4, file$1, 424, 10, 11459);
			add_location(tr1, file$1, 420, 8, 11322);
			attr_dev(label9, "class", "svelte-1atyj0m");
			add_location(label9, file$1, 428, 12, 11596);
			attr_dev(td5, "class", "cellleft svelte-1atyj0m");
			add_location(td5, file$1, 427, 10, 11562);
			attr_dev(td6, "class", "cellleft bordernull svelte-1atyj0m");
			add_location(td6, file$1, 430, 10, 11670);
			attr_dev(td7, "rowspan", "2");
			attr_dev(td7, "class", "borderleft svelte-1atyj0m");
			add_location(td7, file$1, 433, 10, 11800);
			add_location(tr2, file$1, 426, 8, 11547);
			attr_dev(label10, "class", "svelte-1atyj0m");
			add_location(label10, file$1, 439, 12, 11977);
			attr_dev(td8, "class", "cellleft svelte-1atyj0m");
			add_location(td8, file$1, 438, 10, 11943);
			attr_dev(td9, "class", "cellleft svelte-1atyj0m");
			add_location(td9, file$1, 441, 10, 12051);
			add_location(tr3, file$1, 437, 8, 11928);
			attr_dev(table, "class", "bordernull svelte-1atyj0m");
			add_location(table, file$1, 408, 6, 10827);
			attr_dev(div15, "class", "centereditem svelte-1atyj0m");
			add_location(div15, file$1, 407, 4, 10794);
			attr_dev(div16, "class", "row svelte-1atyj0m");
			add_location(div16, file$1, 406, 2, 10772);
			attr_dev(label11, "class", "svelte-1atyj0m");
			add_location(label11, file$1, 449, 8, 12236);
			add_location(br12, file$1, 450, 8, 12267);
			attr_dev(label12, "class", "svelte-1atyj0m");
			add_location(label12, file$1, 451, 8, 12282);
			add_location(br13, file$1, 452, 8, 12321);
			attr_dev(label13, "class", "svelte-1atyj0m");
			add_location(label13, file$1, 453, 8, 12336);
			attr_dev(div17, "class", "leftitem svelte-1atyj0m");
			add_location(div17, file$1, 448, 6, 12205);
			add_location(br14, file$1, 457, 8, 12442);
			add_location(strong1, file$1, 458, 8, 12457);
			add_location(br15, file$1, 460, 8, 12576);
			attr_dev(div18, "class", "rightitem svelte-1atyj0m");
			add_location(div18, file$1, 455, 6, 12391);
			attr_dev(div19, "class", "row svelte-1atyj0m");
			add_location(div19, file$1, 447, 4, 12181);
			attr_dev(div20, "class", "yelowkob svelte-1atyj0m");
			add_location(div20, file$1, 446, 2, 12154);
			attr_dev(label14, "class", "svelte-1atyj0m");
			add_location(label14, file$1, 470, 8, 12804);
			add_location(br16, file$1, 471, 8, 12843);
			attr_dev(label15, "class", "svelte-1atyj0m");
			add_location(label15, file$1, 472, 8, 12858);
			attr_dev(div21, "class", "leftitem svelte-1atyj0m");
			add_location(div21, file$1, 469, 6, 12773);
			add_location(br17, file$1, 476, 8, 12972);
			attr_dev(div22, "class", "rightitem svelte-1atyj0m");
			add_location(div22, file$1, 474, 6, 12913);
			attr_dev(div23, "class", "row svelte-1atyj0m");
			add_location(div23, file$1, 468, 4, 12749);
			attr_dev(div24, "class", "yelowkob svelte-1atyj0m");
			add_location(div24, file$1, 467, 2, 12722);
			add_location(br18, file$1, 482, 2, 13066);
			attr_dev(label16, "class", "svelte-1atyj0m");
			add_location(label16, file$1, 485, 6, 13126);
			add_location(br19, file$1, 486, 6, 13183);
			attr_dev(div25, "class", "leftitem svelte-1atyj0m");
			add_location(div25, file$1, 484, 4, 13097);
			attr_dev(label17, "class", "svelte-1atyj0m");
			add_location(label17, file$1, 490, 6, 13274);
			add_location(br20, file$1, 491, 6, 13311);
			attr_dev(div26, "class", "rightitem svelte-1atyj0m");
			add_location(div26, file$1, 489, 4, 13244);
			attr_dev(div27, "class", "row svelte-1atyj0m");
			add_location(div27, file$1, 483, 2, 13075);
			attr_dev(label18, "class", "svelte-1atyj0m");
			add_location(label18, file$1, 511, 6, 13816);
			add_location(br21, file$1, 512, 6, 13850);
			attr_dev(div28, "class", "leftitem svelte-1atyj0m");
			add_location(div28, file$1, 510, 4, 13787);
			attr_dev(div29, "class", "rightitem svelte-1atyj0m");
			add_location(div29, file$1, 516, 4, 13982);
			attr_dev(div30, "class", "row svelte-1atyj0m");
			add_location(div30, file$1, 509, 2, 13765);
			attr_dev(div31, "class", "leftitem svelte-1atyj0m");
			add_location(div31, file$1, 527, 4, 14181);
			attr_dev(div32, "class", "rightitem svelte-1atyj0m");
			add_location(div32, file$1, 531, 4, 14311);
			attr_dev(div33, "class", "row svelte-1atyj0m");
			add_location(div33, file$1, 526, 2, 14159);
			attr_dev(label19, "class", "svelte-1atyj0m");
			add_location(label19, file$1, 537, 6, 14491);
			attr_dev(div34, "class", "leftitem padtop5 svelte-1atyj0m");
			add_location(div34, file$1, 536, 4, 14454);
			attr_dev(div35, "class", "rightitem svelte-1atyj0m");
			add_location(div35, file$1, 540, 4, 14568);
			attr_dev(div36, "class", "row svelte-1atyj0m");
			add_location(div36, file$1, 535, 2, 14432);
			attr_dev(label20, "class", "svelte-1atyj0m");
			add_location(label20, file$1, 552, 6, 14802);
			attr_dev(div37, "class", "leftitem padtop5 svelte-1atyj0m");
			add_location(div37, file$1, 551, 4, 14765);
			attr_dev(div38, "class", "rightitem svelte-1atyj0m");
			add_location(div38, file$1, 554, 4, 14862);
			attr_dev(div39, "class", "row svelte-1atyj0m");
			add_location(div39, file$1, 550, 2, 14743);
			add_location(br22, file$1, 564, 2, 15098);
			add_location(br23, file$1, 565, 2, 15107);
			add_location(br24, file$1, 567, 2, 15180);
			add_location(br25, file$1, 568, 2, 15189);
			add_location(br26, file$1, 572, 2, 15296);
			add_location(br27, file$1, 573, 2, 15305);
			attr_dev(main, "class", "svelte-1atyj0m");
			add_location(main, file$1, 309, 0, 8392);
		},
		m: function mount(target, anchor) {
...
//# sourceMappingURL=data:application/json;charset=utf-8;base64,
